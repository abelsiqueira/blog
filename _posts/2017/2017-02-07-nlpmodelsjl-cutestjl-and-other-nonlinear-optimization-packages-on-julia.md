@def name = "2017-02-07-nlpmodelsjl-cutestjl-and-other-nonlinear-optimization-packages-on-julia"
@def blogpost = true
...
*Edit: Second part is
[here](https://abelsiqueira.github.io{{prepath}}nlpmodelsjl-and-cutestjl-constrained-optimization/).*
